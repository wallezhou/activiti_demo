...
public class ActivitiTest {
    ...
    public void creatActivitiTask(){
        ...
        processEngine.getRepositoryService()
                .createDeployment()
                .addClasspathResource("data/shenqing.bpmn")
                .addClasspathResource("data/shenqing.png")
                .deploy();
    }
    /**
     * 2：启动流程实例
    ...
    public void testStartProcessInstance(){
        ...
        processEngine.getRuntimeService()
                .startProcessInstanceById("myProcess_1:1:5004");  //这个是查看数据库中act_re_procdef表
    }
    /**
     * 完成请假申请
     */
    ...
    public void testFinishTask_Boss(){
        ProcessEngine processEngine = ProcessEngines.getDefaultProcessEngine();
        processEngine.getTaskService()
                .complete("12502");  //查看act_ru_task数据表
    }
}